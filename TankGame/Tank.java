...
public class Tank extends Player {
    ...
    public Tank(int x, int y, boolean good, GameWorld game) {
        ...
        try {
            BufferedImage tempImg = good ? ImageIO.read(GameWorld.class.getResource("../Resources/Tank_blue.png")) : ImageIO.read(GameWorld.class.getResource("../Resources/Tank_red.png"));
